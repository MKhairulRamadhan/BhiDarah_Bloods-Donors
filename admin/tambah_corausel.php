      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="">Tambah Corausel</a>
            ...
            <div class="col-md-12">
              ...
              <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-row file">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="file" name="gambar" accept="image/*" id="file" style="width: 100%; border-bottom: 1px solid darkgrey;" required>
                  </div>
                </div>
                <br>
              ...
              <?php 
                if (isset($_POST['tambah'])) {
                  ...
                  $koneksi->query("INSERT INTO event_corausel 
                  (event,judul,keterangan,gambar,tanggal)
                  VALUES('$event', '$judul', '$keterangan', '$gambar', '$tanggal')");
