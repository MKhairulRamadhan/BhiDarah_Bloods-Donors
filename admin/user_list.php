            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">List user yang mendaftar di bhi.darah</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php $nomor = 1; ?>
                        <?php $ambil = $koneksi->query("SELECT * FROM user WHERE role NOT IN('admin')"); ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $pecah['tgl_user'] ?></td>
                          <td><?php echo $pecah['alamat_user'] ?></td>
                          <td>
                            <img width="110px" src="../image/profil/<?php echo $pecah['gambar_user']?>" alt="">
                          </td>
                          <td>
                            <a href="hapus_user.php?id=<?php echo $pecah['id_user'];?>" title="" class="btn btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php $nomor++; ?>
                        <?php } ?>
