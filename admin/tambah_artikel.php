      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="">Tambah Artikel</a>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            <textarea class="form-control ckeditor" name="isi" id="ckedtor" rows="5" required></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                    <button type="submit" name="simpan" class="btn btn-primary pull-right">Buat Artikel</button>
                  ...
                  <?php 
                    if (isset($_POST['simpan'])) {
                      ...
                      move_uploaded_file($lokasifoto, "../image/artikel/".$namaFoto);
                      $tanggal = date('Y-m-d');
                      $koneksi->query("INSERT INTO artikel (gambar_artikel, judul_artikel, isi_artikel, tgl_artikel) VALUES ('$namaFoto', '$_POST[judul]','$_POST[isi]', '$tanggal')");
