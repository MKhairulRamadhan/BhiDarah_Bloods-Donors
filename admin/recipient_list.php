            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Data-data recipient yang dilakukan user</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      <thead class=" text-primary">
                        ...
                        <th>email</th>
                        <th>No Hp</th>
                        <th>Darah Yg Dibutuhkan</th>
                        <th>Gambar</th>
                        <th>Aksi</th>
                      </thead>
                      <tbody>
                        <?php $nomor = 1; ?>
                        <?php $ambil = $koneksi->query("SELECT * FROM recipient JOIN user WHERE user.id_user = recipient.id_user GROUP BY id_recipient"); ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo $pecah['gol_darah_butuh'] ?></td>
                          <td>
                            <img width="110px" src="../image/profil/<?php echo $pecah['gambar_user']?>" alt="">
                          </td>
                          <td>
                            <a href="hapus_recipient.php?id=<?php echo $pecah['id_recipient'];?>" title="" class="btn btn-danger">Hapus</a>
                            <a href="detail_recipient.php?id=<?php echo $pecah['id_recipient'];?>" title="" class="btn btn-warning">Detail</a>
                          </td>
                        </tr>
                        <?php $nomor++; ?>
                        <?php } ?>
