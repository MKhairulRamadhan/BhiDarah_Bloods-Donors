            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Artikel-Artikel</h4>
                  <p class="card-category">Artikel yang dibuat oleh admin</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <img width="110px" src="../image/artikel/<?php echo $pecah['gambar_artikel']?>" alt="Gambar">
                          </td>
                          <td><?php echo $pecah['judul_artikel'] ?></td>
                          <td><?php echo $pecah['tgl_artikel'] ?></td>
                          <td>
                            <a href="ubah_artikel.php?id=<?php echo $pecah['id_artikel'];?>" title="" class="btn btn-warning">Ubah</a>
                            <a href="hapus_artikel.php?id=<?php echo $pecah['id_artikel'];?>" title="" class="btn btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php $nomor++; ?>
                        <?php } ?>
                    ...
                    <a href="tambah_artikel.php" class="btn btn-info">Tambah Artikel</a>
                  </div>
                </div>
              </div>
            </div>
